...
logx=0
logy=0
rawfile=$netlist_dir/COMP_NMOS_IP_TB.raw
autoload=1
sim_type=tran
digital=1}
...
C {/foss/designs/SAR_ADC_8_Bit_IHP130/COMP/COMP_NMOS_IP.sym} 700 -90 0 0 {name=x1}
...
C {lab_pin.sym} 1110 -210 3 0 {name=p3 sig_type=std_logic lab=AVSS}
C {lab_pin.sym} 1070 -210 3 0 {name=p4 sig_type=std_logic lab=AVSS}
...
C {lab_pin.sym} 1030 -210 3 0 {name=p8 sig_type=std_logic lab=CLK}
C {vsource.sym} 450 -190 0 0 {name=V4 value=0.75 savecurrent=false}
